...
mod light_client {
    mod test {
        ...
        use light_client::{Block, BlockHeaderInnerLite, LightClient, Validator};
        ...
        fn adding_block_in_first_epoch() {
            ...
            // TODO uncomment when add_light_client_block will do something
            //assert!(encode_hex(&bridge.block_hashes(304).unwrap()) == "92c231eb7719d7cc7598e7bc614bbd0eb0be3729b47a36ede4a66033aa5051d9");

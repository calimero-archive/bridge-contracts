...
use utils::{
    ...
    option_base64_format, string_bytes_format_many, swap_bytes16, swap_bytes4, swap_bytes8,
    u128_dec_format, u64_dec_format, u64_dec_format_compatible, Hash, Hashable,
};
